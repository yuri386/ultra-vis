(() => {
  ...
  const rows = [
    ...
    ['Return to SkillLand', 'Вернуться в SkillLand', 'SkillLand-ке оралу'], ['Ultra VIS is powered by your SkillLand profile.', 'Ultra VIS работает на основе твоего профиля SkillLand.', 'Ultra VIS сіздің SkillLand профиліңіз негізінде жұмыс істейді.']
  ];
